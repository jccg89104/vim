...
void socket_buf_init(uint8 * tx_size, uint8 * rx_size,int fd); // setting tx/rx buf size
...
uint8 getSn_IR(SOCKET s,int fd); // get socket interrupt status
uint8 getSn_SR(SOCKET s,int fd); // get socket status
uint16 getSn_TX_FSR(SOCKET s,int fd); // get socket TX free buf size
uint16 getSn_RX_RSR(SOCKET s,int fd); // get socket RX recv buf size
uint8 getSn_SR(SOCKET s,int fd);
void setSn_TTL(SOCKET s, uint8 ttl);
void send_data_processing(SOCKET s, uint8 *wizdata, uint16 len,int fd);
void recv_data_processing(SOCKET s, uint8 *wizdata, uint16 len,int fd);
...
uint16 wiz_write_buf(uint32 addrbsb,uint8* buf,uint16 len,int fd);	
uint16 wiz_read_buf(uint32 addrbsb, uint8* buf,uint16 len,int fd);
